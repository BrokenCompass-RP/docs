...
export default async function HomePage({ searchParams }) {
  ...
  return (
    <main className="shell landing">
      <div className="home-header"><p className="eyebrow">Broken Compass knowledge</p><AuthControls authorization={authorization} /></div>
      ...
      <DevIdentitySwitcher identity={authorization.identity} returnTo="/" />
      ...
      <ViewAsControl identity={authorization.identity} projection={projection} returnTo="/" />
    </main>
  );
}
